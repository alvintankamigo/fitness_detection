...
def relative_landmark(landmark_list):
    ...
    # shoulder_length_y = abs(temp_landmark_list[11][1]-temp_landmark_list[12][1])
    # shoulder_length_z = abs(temp_landmark_list[11][2]-temp_landmark_list[12][2])
    # print(shoulder_length_x)
